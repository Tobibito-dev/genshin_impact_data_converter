...
lang_keys = ["chs", "cht", "de", "en", "es", "fr", "id", "ja", "ko", "pt", "ru", "th", "vi"]
# TODO: lang keys
...
# TODO: artifact slot stuff

substat_prop_type_map = {
    "FIGHT_PROP_HP": "hp",
