sheet = {
    ...
    # Max Duration
    "max_duration": [3941187316, "skillParam"],
    # Max Stacks
    "max_stacks": [3866880591, "skillParam"],
    # Skill DMG
    "skill_dmg": [2068254014, "skillParam"],
    # Burst DMG
    "burst_dmg": [1434446270, "skillParam"],
    # DMG Absorption
    "dmg_absorption": [1339275302, "skillParam"],
    # Healing
    ...
    # Energy Cost
    "energy_cost": [3073197810, "skillParam"],
    # Base DMG
    "base_dmg": [430832806, "skillParam"],
    # DoT
    "dot": [1521507646, "skillParam"],
    # Additional Elemental DMG
    "add_ele_dmg": [3006681174, "skillParam"],
}
